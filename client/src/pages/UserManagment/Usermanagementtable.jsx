...
const Usermanagementtable = ({ data, loading, fetchUsers }) => {
  ...
  }, [form, fetchUsers, modalState.selectedUserId]);
  ...
  const handleDelete = useCallback(async () => {
    try {
      const selectedUser = data.find(
        (user) => user._id === modalState.selectedUserId
      );
      form.resetFields();
      if (selectedUser) {
        const userData = {
        ...
        await deleteUser(modalState.selectedUserId, userData);
      }
  ...
  }, [data, fetchUsers, form, modalState.selectedUserId]);
  ...
  const handleModalOk = useCallback(() => {
    if (modalState.selectedUserId) {
      handleDelete(modalState.selectedUserId);
    }
  }, [handleDelete, modalState.selectedUserId]);
