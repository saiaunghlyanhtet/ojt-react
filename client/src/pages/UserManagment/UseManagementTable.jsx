...
const UserManagementTable = ({ data, loading, fetchUsers }) => {
    ...
    }, [form, fetchUsers, modalState.selectedUserId, userInfo]);
    ...
    const handleModalOk = useCallback(() => {
        if (modalState.selectedUserId) {
            handleDeleteUser(form, data, modalState.selectedUserId, userInfo);
        }
    }, [form, data, handleDeleteUser, modalState.selectedUserId, userInfo]);
